...
- [SSALTO/DUACS Experimental Product Handbook: Gridded Sea Level Heights and geostrophic velocities computed with SWOT Level-3 products (using both KaRIn and nadir instruments)](https://www.aviso.altimetry.fr/fileadmin/documents/data/tools/hdbk_duacs_experimental_miost_4dvarnet_4dvarqg_swot.pdf)
- [SWOT Level-3 Product Frequently Asked Questions](https://www.aviso.altimetry.fr/fileadmin/documents/data/tools/swot_l3_faqL3alphav0_3_rev1.pdf)

# High-Frequency Radar (HFR) Data
- [NOAA IOOS - Central & Northern California Ocean Observing System](https://www.cencoos.org/)
